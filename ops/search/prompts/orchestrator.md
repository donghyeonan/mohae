...
2. Spawn source-diverse memory-assisted discovery workers and at least one blank-slate worker.
...
7. Only after union, send candidates for official enrichment and evidence assembly.
...
10. Record stage-specific failures and compare blank-slate novelty against memory-assisted coverage.
